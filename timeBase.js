const STAGE2_BLUR_MIN_GAP  = 5000; 
const STAGE2_BLUR_MAX_GAP  = 8000; 
const STAGE2_BLUR_DURATION = 200; 
const STAGE2_BLUR_AMOUNT   = 6; 

const STAGE2_SHAKE_MIN_GAP  = 4000; 
const STAGE2_SHAKE_MAX_GAP  = 8000;
const STAGE2_SHAKE_DURATION = 100; 
